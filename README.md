...
- Na pasta `notebooks` estão os notebooks com o desenvolvimento do projeto: [Análise exploratória](notebooks/01-eda.ipynb) e [Criação do modelo](notebooks/02-segmentacao.ipynb)
